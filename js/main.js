  ...
  const JOURNEY = [
    {
      ...
      tags: ['Robotics', 'LEGO Mindstorms EV3', 'Teaching', 'Competitive'],
    },
    {
      ...
      bullets: [
        ...
        "Applied software engineering principles in collaborative full-stack development projects.",
        "Learned about business domain through elective accounting and decision theory classes.",
        "Thesis: \"Enabling Voice Input for Data Entry through LLMs in MontiGem\" at RWTH Chair of Software Engineering.",
      ],
      tags: [
        "Computer Science",
        "Bachelor",
    ...
    },
    {
      ...
      tags: ['Python', 'Pandas', 'Pickle', 'Teaching', 'Data Science'],
    },
    {
      ...
      tags: ['Python', 'Flask', 'Docker', 'REST', 'Multiprocessing', "MongoDB"],
    },
    {
      id: 'oelmuehle', kind: 'work-mag', label: 'Fullstack Dev · Teuto Ölmühle',
    ...
    "Planned and executed GCF's first-ever Tech & AI Exhibition at Board 44 over 4+ months, coordinating 8 departments, 4 booths, and 16+ initiatives while engaging Board members, accredited entities, and country representatives across AI governance, data protection, digital equity, and organizational efficiency.",
    "Designed and implemented data pipelines and analytical models to support climate-related forecasting and country vulnerability assessments (Microsoft Fabric, Kerchunk/NetCDF indexing, NLP).",
    "Executed large-scale data migration and data cleaning, including automated validation processes to ensure data quality and reliability.",
    "Supported AI and automation initiatives to improve internal workflows and operational efficiency using Asana, n8n, Azure, Microsoft Copilot, and Microsoft Power Platform.",
    "Designed and implemented an AI-assisted longlisting solution, improving process efficiency by over 3× while maintaining evaluation quality and consistency.",
    "Developed enterprise Finance and HR platforms using Next.js, TypeScript, PostgreSQL, Azure, and SAML/SCIM, including a multi-year budgeting platform with approval workflows, SSO and DocuSign integration, and an internal awards and nomination system with role-based access and dashboards."
],
      tags: [
      "Python",
      "Microsoft Fabric",
      ...
      images: ['assets/images/experience/gcf-3.jpg', 'assets/images/experience/gcf-2.jpg', 'assets/images/experience/gcf-1.jpg'],
    },
    {
