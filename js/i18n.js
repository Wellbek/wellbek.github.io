...
export const STRINGS = {
  ...
  de: {
    'profile.sub': 'KI-Systeme • Data Engineering • IT-Projektmanagement • Enterprise-Plattformen',
    'profile.loc': 'Seoul, KR · zuvor Aachen, DE',
    'profile.langs': 'Deutsch (Muttersprache), Englisch (fließend), Koreanisch (Mittelstufe)',
    'about.lede': 'Ich bin Louis, Software- und Data Scientist sowie Engineer mit einer Leidenschaft für den Entwurf großskaliger Systeme, insbesondere solcher mit komplexen und datenintensiven Workloads. Meine Berufserfahrung umfasst KI, Data Engineering, Enterprise-Software und technisches Projektmanagement in Forschung, Industrie und internationalen Organisationen.',
    'about.body': 'Beim <a href="https://greenclimate.fund/" target="_blank" rel="noopener noreferrer" class="hi">Green Climate Fund</a> war ich als Technical Business Partner tätig, leitete bereichsübergreifende Initiativen zur digitalen Transformation und entwickelte KI-gestützte Anwendungen, Enterprise-Plattformen und großskalige Klimadaten-Pipelines. Zuvor habe ich Analyseplattformen gebaut, an der RWTH Aachen Data Science unterrichtet und Enterprise-Software von Grund auf neu entwickelt. Derzeit absolviere ich meinen M.S. in Data Science an der KAIST und forsche im <span class="hi">System Analytics Lab</span> bei Professor <a href="mailto:hyshin@kaist.edu" class="hi">Dr. Hayong Shin</a> zu Reinforcement Learning für Fertigungs-Scheduling, mit Fokus auf Policy-Optimierung und modernen LLM-Post-Training-Methoden (TRPO, PPO, GRPO und Varianten).',
    'fact.role': 'rolle',
    ...
    'fact.languages.v': 'Deutsch (Muttersprache), Englisch (fließend), Koreanisch (Mittelstufe)',

    'col.journey': 'erfahrung<br>&amp; ausbildung',
    'tab.chart': 'diagramm',
    'tab.list': 'liste',
    'freelance': 'Freelance &amp; Nebenprojekte',
    'now': 'jetzt',
    'journey.hint': '// Block anklicken für Details',
    'legend.edu': 'Ausbildung',
    'list.work': 'berufserfahrung',
    'list.edu': 'ausbildung',
    'list.act': 'aktivitäten &amp; vereine',

    'col.research': 'forschung',
    'pub.thesis': 'Bachelorarbeit · RWTH SE',
    'pub.hpc.meta': 'Seminar · RWTH HPC',
    'pub.vr.meta': 'Seminar · RWTH VR',
    'pub.voice.abs': 'Spracheingabe in natürlicher Sprache für strukturierte Dateneingabe im MontiGem-Framework, mit LLMs für Intent-Erkennung und Slot Filling.',
    'pub.hpc.abs': 'Vergleichende Analyse von Regressionstest-Frameworks für HPC hinsichtlich Korrektheit, Overhead und Skalierbarkeit in parallelen Umgebungen.',
    ...
    'proj.thinkslides.desc': 'Mandantenfähige App, die gebrandete PowerPoint-Präsentationen über einen ReAct-Agenten erzeugt, der Gedanken + Tool Calls per SSE streamt. Stack aus 5 Services.',
    ...
    'proj.greenlense.name': 'Agentische Produkt-Insights-API - Finalist Hack Seoul 2025 (AngelHack x Coupang)',
    'proj.greenlense.desc': 'Agentische KI-API für Produkt-Insights in 36 Stunden gebaut - Finalist bei Hack Seoul 2025.',
    'proj.wellm.name': 'Neovim-Plugin für LLM-Integration',
    'proj.wellm.desc': 'Vollständig asynchrone Streaming-LLM-Integration für Neovim - natives Function Calling, Symbol-Outline-Injection reduziert den Kontext um ~90 %.',
    ...
    'mini.psp': 'Ein einfaches Betriebssystem in C für einen Mikrocontroller - gekrönt von Snake.',
    ...
    'mini.portfolio': 'Diese Seite - Terminal-Ästhetik, prozeduraler ASCII-Boid-Schwarm.',
    'mini.physics': 'Eigene Physik-Engine in Godot für ein 3D-Tower-Defense-Spiel.',
    'mini.watt': '48h RWTH Game Jam 2024 - Platz 2 im 4er-Team.',
    'mini.tft': 'Mein TFT in Godot mit Steamworks-Multiplayer.',
...
export const JOURNEY_I18N = {
  de: {
    ...
    bsc: {
      ...
      bullets: [
        'Fundierte Grundlagen in Mathematik, Algorithmen, Softwaretechnik, Datenbanken, Betriebssystemen und verteilten Systemen.',
    ...
    ra: {
      ...
      bullets: [
        ...
        'Refaktorierte die Analyse-Pipeline mit Multiprocessing-basiertem Load Balancing und beschleunigte die Datenverarbeitung um bis zu 5×.',
      ],
    },
    oelmuehle: {
      ...
      bullets: [
        ...
        'Refaktorierte die Daten-Pipeline für die direkte Anbindung an Microsoft-NAV-Datenbanken und ermöglichte so Echtzeit-Datenfeedback.',
        'Führte GitHub zur Versionskontrolle ein und baute eine CI/CD-Pipeline mit GitHub Actions auf.',
      ],
    },
    gcf: {
      ...
      bullets: [
        ...
        'Konzipierte und implementierte eine KI-gestützte Longlisting-Lösung, die die Prozesseffizienz um mehr als das 3-Fache steigerte, bei gleichbleibender Qualität und Konsistenz der Bewertung.',
